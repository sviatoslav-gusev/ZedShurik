...
7. Edit ToolPaths.ps1. Replace all paths with Clang and Ninja to actual ones.
8. Open directory with CMakeLists.txt.
9. Ctrl+Alt+R. Configure.
10. Ctrl+Alt+R. Build & Run.
